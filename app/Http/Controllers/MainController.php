...
class MainController extends Controller
{
    ...
    {
        $games = DB::table('games')->paginate(5);
    ...
    {
        $games = DB::table('games')->where('score', '>', 8.5)->paginate(5);
    ...
    public function show(int $gameId)
    {
        $game = DB::table('games')
            ...
            ->select('games.id', 'games.title', 'genres.name as genre_name', 'publishers.name as publisher_name', 'games.platform', 'games.publicate_date', 'games.description', 'games.score')
