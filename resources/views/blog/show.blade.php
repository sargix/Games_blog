...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">ID: {{ $game[0]->id }}.</h4>
            <h2 class="card-title">Tytuł: {{ $game[0]->title }}</h2>
            <h5 class="card-title">Gatunek: {{ $game[0]->genre_name }}</h5>
            <h5 class="card-title">Wydawca: {{ $game[0]->publisher_name }}</h5>
            <h5 class="card-title">Platformy: {{ $game[0]->platform }}</h5>
            <h5 class="card-title">Data wydania: {{ $game[0]->publicate_date }}</h5>
            <h5 class="card-title">Ocena: {{ $game[0]->score }}</h5>
